        ...
        try {
            ...
            Integer migratedTables = persistence.database().query(connection -> {
                try (var statement = connection.prepareStatement(
                    ...
                    statement.setString(5, persistence.database().table(DatabaseTables.COMMAND_INTENTS));
                    statement.setString(6, persistence.database().table(DatabaseTables.FLYWAY_HISTORY));
